...
Abmd	|SV*	|hv_delete	|NULLOK HV* hv|NN const char *key|I32 klen \
				|I32 flags
Abmd	|SV*	|hv_delete_ent	|NULLOK HV* hv|NN PV *keysv|I32 flags|U32 hash
AbmdR	|bool	|hv_exists	|NULLOK HV* hv|NN const char *key|I32 klen
AbmdR	|bool	|hv_exists_ent	|NULLOK HV* hv|NN PV *keysv|U32 hash
Abmd	|SV**	|hv_fetch	|NULLOK HV* hv|NN const char *key|I32 klen \
				|I32 lval
Abmd	|HE*	|hv_fetch_ent	|NULLOK HV* hv|NN PV *keysv|I32 lval|U32 hash
...
Apda	|PV*	|newSVpv	|NULLOK const char *const s|const STRLEN len
Apda	|PV*	|newSVpvn	|NULLOK const char *const s|const STRLEN len
Apda	|PV*	|newSVpvn_flags	|NULLOK const char *const s|const STRLEN len|const U32 flags
Apda	|SV*	|newSVhek	|NULLOK const HEK *const hek
Apda	|PV*	|newSVpvn_share	|NULLOK const char* s|I32 len|U32 hash
Apda	|PV*	|newSVpv_share	|NULLOK const char* s|U32 hash
Afpda	|PV*	|newSVpvf	|NN const char *const pat|...
Apa	|PV*	|vnewSVpvf	|NN const char *const pat|NULLOK va_list *const args
...
Apda	|OP*	|newMETHOP_named|I32 type|I32 flags|NN PV* const_meth
...
Amb	|char*	|sv_2pv		|NN PV* sv|NULLOK STRLEN *lp
...
Amdb	|void	|sv_catpvn	|NN PV* dsv|NN const char *sstr|STRLEN len
Amdb	|void	|sv_catsv	|NN PV* dstr|NULLOK PV *sstr
...
Apdbm	|void	|sv_catsv_mg	|NN PV* dsv|NULLOK SV* ssv
...
s  |bool|gv_is_in_main|NN const char *name|STRLEN len \
                      |const U32 is_utf8
s	|HV*	|require_tie_mod|NN GV *gv|NN const char *varpv|NN PV* namesv \
...
sR	|PerlIO *|doopen_pm	|NN PV* name
#endif
...
Aop	|SV*	|mro_set_private_data|NN struct mro_meta *const smeta \
				     |NN const struct mro_alg *const which \
				     |NN SV* const data
Aop	|const struct mro_alg *|mro_get_from_name|NN PV* name
