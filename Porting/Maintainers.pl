...
%Modules = (
    ...
    'B::C' => {
        'DISTRIBUTION' => 'RURBAN/B-C-1.54_11.tar.gz',
        'FILES'        => q[cpan/B-C],
        'EXCLUDED'     => [
            qr{^.gdb},
            qr{^t/z_pod\.t/},
    ...
    'Cpanel::JSON::XS' => {
        'DISTRIBUTION' => 'RURBAN/Cpanel-JSON-XS-3.0217.tar.gz',
    ...
    'Devel::PPPort' => {
        'DISTRIBUTION' => 'WOLFSAGE/Devel-PPPort-3.33.tar.gz',
    ...
    'Math::BigInt' => {
        'DISTRIBUTION' => 'PJACKLAM/Math-BigInt-1.999722.tar.gz',
