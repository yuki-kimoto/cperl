...
$bits{$_}{7} = 'OPpLVAL_INTRO' for qw(aelem aslice cond_expr delete enteriter entersub enterxssub gvsv helem hslice int_padsv list lvavref lvref lvrefslice multideref num_padsv padav padhv padrange padsv pushmark refassign rv2av rv2gv rv2hv rv2sv str_padsv uint_padsv);
$bits{$_}{2} = 'OPpLVREF_ELEM' for qw(lvref refassign);
$bits{$_}{3} = 'OPpLVREF_ITER' for qw(lvref refassign);
$bits{$_}{3} = 'OPpMAYBE_LVSUB' for qw(aassign aelem aelem_u aslice av2arylen helem hslice keys kvaslice kvhslice multideref padav padhv pos rv2av rv2gv rv2hv substr vec);
...
our %ops_using = (
    ...
    OPpLVAL_INTRO            => [qw(aelem aslice cond_expr delete enteriter entersub enterxssub gvsv helem hslice int_padsv list lvavref lvref lvrefslice multideref num_padsv padav padhv padrange padsv pushmark refassign rv2av rv2gv rv2hv rv2sv str_padsv uint_padsv)],
    OPpLVREF_ELEM            => [qw(lvref refassign)],
    OPpMAYBE_LVSUB           => [qw(aassign aelem aelem_u aslice av2arylen helem hslice keys kvaslice kvhslice multideref padav padhv pos rv2av rv2gv rv2hv substr vec)],
